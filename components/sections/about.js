    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        ...
        data-aos-delay="400">About us</h2>
            <p class="small-text">
            We take the time to get to know you and ask the right questions. We treat you like family, you can relax, look good, feel good and even have fun. Deakin Dental is the perfect match for your gnashers.
            </p>        
          </div>
